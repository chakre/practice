...
<![endif]-->
  ...
  <div class="container-fluid">
    ...
    <div class="banner">
        ...
        <!-- <img src="images/scene.jpg" alt="scenary">
    ...
    <div class="about">
       <div class="container">
          ...
          <h2>ABOUT US</h2>
       <p>
            There are many variat  ions of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, 
            ...
            tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200
             ...
             on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem
     ...
     <div class="container">
      <div class="row">
         <div class="col-md-4">
          ...
          <h2>Contact Us</h2>
          <p>
              Chamuna Road, 3 Nepal.</br>
              Suneelcoool@hotmail.com</br>
              9841663366</br>
              www.webia.com</br>
         ...
         <div class="services">
              <h2>Services</h2>
                 <p> It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, 
                  ...
                  The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words.</p>
          </div>
      </div>
  ...
  <footer>
    <div class="footer-content">
       <p>
          copy right 2014 , powered by <a href="#">sunil chakradhar</a><br>
